...
keyperiod<-c(2001,2002,2003,2004,2005,2006,2007,2008,2009,2010,2011,2012,2013,2014,2015)
...
# Panel
reg_p <- pglm(Count ~ SpatialLag.Count.Lag + yrsoffc + eiec + gov_left + gov_right + GovEffectiveness + GDP_PC  + GHG_Int + Gini, data=dataCSE[which(dataCSE$Year %in% keyperiod),], index=c("ISO","Year"), model = "within", effect = "twoways", family = poisson)
res <- summary(reg_p)
res


res<-pois.fe.robust(outcome="Count", xvars=c("SpatialLag.Count.Lag", "yrsoffc", "eiec", "gov_left","gov_right", "GovEffectiveness", "GDP_PC", "GHG_Int", "Gini"), group.name="ISO", data=dataCSE[which(dataCSE$Year %in% keyperiod),], qcmle.coefs = NULL, allow.set.key = FALSE, index.name = NULL)
...
pois.fe.output(res)
write.csv(pois.fe.output(res), file="D:/Projects/2_Working Papers/Margherita/Revision NComm 2025/01-15/ResCountAggregate_CPDEPS.csv")
# 
# 
# 
...
reg_p <- pglm(Count ~ Count.Lag + SpatialLag.Count.Lag + yrsoffc + eiec + gov_left + gov_right + GovEffectiveness + GDP_PC  + GHG_Int + Gini, data=dataCSE[which(dataCSE$Year %in% keyperiod),], index=c("ISO","Year"), model = "within", effect = "twoways", family = poisson)
res <- summary(reg_p)
res

res<-pois.fe.robust(outcome="Count", xvars=c("Count.Lag","SpatialLag.Count.Lag", "yrsoffc", "eiec", "gov_left","gov_right", "GovEffectiveness", "GDP_PC", "GHG_Int", "Gini"), group.name="ISO", data=dataCSE[which(dataCSE$Year %in% keyperiod),], qcmle.coefs = NULL, allow.set.key = FALSE, index.name = NULL)

pois.fe.output(res)
write.csv(pois.fe.output(res), file="D:/Projects/2_Working Papers/Margherita/Revision NComm 2025/01-15/ResCountAggregate_CPDEPS_lag.csv")
# 
# 
# reg_pformula <- function(factors) {
#     if (length(factors) == 0) return(0)
...
# Panel Market Instr
reg_p <- pglm(Market.Instr ~ SpatialLag.Market.Instr.Lag + yrsoffc + eiec + gov_left + gov_right + GovEffectiveness + GDP_PC  + GHG_Int + Gini, data=dataCSE[which(dataCSE$Year %in% keyperiod),], index=c("ISO","Year"), model = "within", effect = "twoways", family = poisson)
res <- summary(reg_p)
res

res<-pois.fe.robust(outcome="Market.Instr", xvars=c("SpatialLag.Market.Instr.Lag", "yrsoffc", "eiec", "gov_left","gov_right", "GovEffectiveness", "GDP_PC", "GHG_Int", "Gini"), group.name="ISO", data=dataCSE[which(dataCSE$Year %in% keyperiod),], qcmle.coefs = NULL, allow.set.key = FALSE, index.name = NULL)
pois.fe.output(res)

# 
write.csv(pois.fe.output(res), file="D:/Projects/2_Working Papers/Margherita/Revision NComm 2025/01-15/ResMarket.InstrAggregate_CPDEPS.csv")
# 
# 
# reg_pformula <- function(factors) {
#     if (length(factors) == 0) return(0)
...
# Panel Market Instr
reg_p <- pglm(Market.Instr ~ Market.Instr.Lag + SpatialLag.Market.Instr.Lag + yrsoffc + eiec + gov_left + gov_right + GovEffectiveness + GDP_PC  + GHG_Int + Gini, data=dataCSE[which(dataCSE$Year %in% keyperiod),], index=c("ISO","Year"), model = "within", effect = "twoways", family = poisson)
res <- summary(reg_p)
res

res<-pois.fe.robust(outcome="Market.Instr", xvars=c("Market.Instr.Lag","SpatialLag.Market.Instr.Lag", "yrsoffc", "eiec", "gov_left","gov_right", "GovEffectiveness", "GDP_PC", "GHG_Int", "Gini"), group.name="ISO", data=dataCSE[which(dataCSE$Year %in% keyperiod),], qcmle.coefs = NULL, allow.set.key = FALSE, index.name = NULL)
pois.fe.output(res)
write.csv(pois.fe.output(res), file="D:/Projects/2_Working Papers/Margherita/Revision NComm 2025/01-15/ResMarket.InstrAggregate_CPDEPS_lag.csv")
# 
# 
# reg_pformula <- function(factors) {
#     if (length(factors) == 0) return(0)
...
reg_p <- pglm(Non.Market.Instr ~ SpatialLag.Non.Market.Instr.Lag + yrsoffc + eiec + gov_left + gov_right + GovEffectiveness + GDP_PC  + GHG_Int + Gini, data=dataCSE[which(dataCSE$Year %in% keyperiod),], index=c("ISO","Year"), model = "within", effect = "twoways", family = poisson)
res <- summary(reg_p)
res

res<-pois.fe.robust(outcome="Non.Market.Instr", xvars=c("SpatialLag.Non.Market.Instr.Lag", "yrsoffc", "eiec", "gov_left","gov_right", "GovEffectiveness", "GDP_PC", "GHG_Int", "Gini"), group.name="ISO", data=dataCSE[which(dataCSE$Year %in% keyperiod),], qcmle.coefs = NULL, allow.set.key = FALSE, index.name = NULL)
pois.fe.output(res)
# 
write.csv(pois.fe.output(res), file="D:/Projects/2_Working Papers/Margherita/Revision NComm 2025/01-15/ResNon.Market.InstrAggregate_CPDEPS.csv")
# 
# 
# reg_pformula <- function(factors) {
#     if (length(factors) == 0) return(0)
...
# Panel Non.Market Instr
reg_p <- pglm(Non.Market.Instr ~ Non.Market.Instr.Lag + SpatialLag.Non.Market.Instr.Lag + yrsoffc + eiec + gov_left + gov_right + GovEffectiveness + GDP_PC  + GHG_Int + Gini, data=dataCSE[which(dataCSE$Year %in% keyperiod),], index=c("ISO","Year"), model = "within", effect = "twoways", family = poisson)
res <- summary(reg_p)
res

res<-pois.fe.robust(outcome="Non.Market.Instr", xvars=c("Non.Market.Instr.Lag","SpatialLag.Non.Market.Instr.Lag", "yrsoffc", "eiec", "gov_left","gov_right", "GovEffectiveness", "GDP_PC", "GHG_Int", "Gini"), group.name="ISO", data=dataCSE[which(dataCSE$Year %in% keyperiod),], qcmle.coefs = NULL, allow.set.key = FALSE, index.name = NULL)
pois.fe.output(res)
write.csv(pois.fe.output(res), file="D:/Projects/2_Working Papers/Margherita/Revision NComm 2025/01-15/ResNon.Market.InstrAggregate_CPDEPS_lag.csv")
# 
# 
# reg_pformula <- function(factors) {
#     if (length(factors) == 0) return(0)
...
# Panel Non.Market Instr
reg_p <- pglm(TechSup.Instr ~ SpatialLag.TechSup.Instr.Lag + yrsoffc + eiec + gov_left + gov_right + GovEffectiveness + GDP_PC  + GHG_Int + Gini, data=dataCSE[which(dataCSE$Year %in% keyperiod),], index=c("ISO","Year"), model = "within", effect = "twoways", family = poisson)
res <- summary(reg_p)
res


res<-pois.fe.robust(outcome="TechSup.Instr", xvars=c("SpatialLag.TechSup.Instr.Lag", "yrsoffc", "eiec", "gov_left","gov_right", "GovEffectiveness", "GDP_PC", "GHG_Int", "Gini"), group.name="ISO", data=dataCSE[which(dataCSE$Year %in% keyperiod),], qcmle.coefs = NULL, allow.set.key = FALSE, index.name = NULL)
pois.fe.output(res)
write.csv(pois.fe.output(res), file="D:/Projects/2_Working Papers/Margherita/Revision NComm 2025/01-15/ResTechSup.InstrAggregate_CPDEPS.csv")
# 
# 
# reg_pformula <- function(factors) {
#     if (length(factors) == 0) return(0)
...
# Panel Non.Market Instr
reg_p <- pglm(TechSup.Instr ~ TechSup.Instr.Lag + SpatialLag.TechSup.Instr.Lag + yrsoffc + eiec + gov_left + gov_right + GovEffectiveness + GDP_PC  + GHG_Int + Gini, data=dataCSE[which(dataCSE$Year %in% keyperiod),], index=c("ISO","Year"), model = "within", effect = "twoways", family = poisson)
res <- summary(reg_p)
res

res<-pois.fe.robust(outcome="TechSup.Instr", xvars=c("TechSup.Instr.Lag","SpatialLag.TechSup.Instr.Lag", "yrsoffc", "eiec", "gov_left","gov_right", "GovEffectiveness", "GDP_PC", "GHG_Int", "Gini"), group.name="ISO", data=dataCSE[which(dataCSE$Year %in% keyperiod),], qcmle.coefs = NULL, allow.set.key = FALSE, index.name = NULL)
pois.fe.output(res)
# 
write.csv(pois.fe.output(res), file="D:/Projects/2_Working Papers/Margherita/Revision NComm 2025/01-15/ResTechSup.InstrAggregate_CPDEPS_lag.csv")
# 
# 
# reg_pformula <- function(factors) {
#     if (length(factors) == 0) return(0)
...
regEPS <- plm(EPS ~ EPS.Lag + SpatialLag.EPS.Lag + yrsoffc + eiec + gov_left + gov_right + GovEffectiveness + GDP_PC + GHG_Int + Gini, data=FlowM[which(FlowM$Year %in% keyperiod),], index=c("ISO","Year"), model = "within", effect = "twoways")
res <- summary(regEPS)
res
res_robust<-coeftest(regEPS, vcov.=vcovHC(regEPS, method="white2", type="HC1"))
res_robust

write.csv(res_robust, file="D:/Projects/2_Working Papers/Margherita/Revision NComm 2025/01-15/EPS_CPDEPS_lag.csv")
...
regEPSd <- plm(EPS_Difference ~ SpatialLag.EPS_Difference.Lag + yrsoffc + eiec + gov_left + gov_right + GovEffectiveness + GDP_PC + GHG_Int + Gini, data=FlowM[which(FlowM$Year %in% keyperiod),], index=c("ISO","Year"), model = "within", effect = "twoways")
res <- summary(regEPSd)
res
res_robust<-coeftest(regEPSd, vcov.=vcovHC(regEPSd, method="white2", type="HC1"))
res_robust
# 
write.csv(res_robust, file="D:/Projects/2_Working Papers/Margherita/Revision NComm 2025/01-15/EPS_Difference_CPDEPS.csv")
# 
# reg_pformula <- function(factors) {
#     if (length(factors) == 0) return(0)
...
#Panel
regEPS_MKT <-plm(EPS_MKT ~ EPS_MKT.Lag + SpatialLag.EPS_MKT.Lag + yrsoffc + eiec + gov_left + gov_right +  GovEffectiveness + GDP_PC + GHG_Int + Gini, data=FlowM[which(FlowM$Year %in% keyperiod),], index=c("ISO","Year"), model = "within", effect = "twoways")
res <- summary(regEPS_MKT)
res
res_robust<-coeftest(regEPS_MKT, vcov.=vcovHC(regEPS_MKT, method="white2", type="HC1"))
res_robust
# 
write.csv(res_robust, file="D:/Projects/2_Working Papers/Margherita/Revision NComm 2025/01-15/EPS_MKT_CPDEPS_lag.csv")
# 
# 
# 
# reg_pformula <- function(factors) {
...
regEPS_MKTd <- plm(EPS_MKT_Difference ~ SpatialLag.EPS_MKT_Difference.Lag + yrsoffc + eiec + gov_left + gov_right + GovEffectiveness + GDP_PC + GHG_Int + Gini, data=FlowM[which(FlowM$Year %in% keyperiod),], index=c("ISO","Year"), model = "within", effect = "twoways")
res <- summary(regEPS_MKTd)
res
res_robust<-coeftest(regEPS_MKTd, vcov.=vcovHC(regEPS_MKTd, method="white2", type="HC1"))
res_robust
# 
write.csv(res_robust, file="D:/Projects/2_Working Papers/Margherita/Revision NComm 2025/01-15/EPS_MKT_Difference_CPDEPS.csv")
# 
# reg_pformula <- function(factors) {
#     if (length(factors) == 0) return(0)
...
#Panel
regEPS_NMKT <-plm(EPS_NMKT ~ EPS_NMKT.Lag + SpatialLag.EPS_NMKT.Lag + yrsoffc + eiec + gov_left + gov_right + GovEffectiveness + GDP_PC + GHG_Int + Gini, data=FlowM[which(FlowM$Year %in% keyperiod),], index=c("ISO","Year"), model = "within", effect = "twoways")
res <- summary(regEPS_NMKT)
res
res_robust<-coeftest(regEPS_NMKT, vcov.=vcovHC(regEPS_NMKT, method="white2", type="HC1"))
res_robust
# 
write.csv(res_robust, file="D:/Projects/2_Working Papers/Margherita/Revision NComm 2025/01-15/EPS_NMKT_CPDEPS_lag.csv")
# 
# reg_pformula <- function(factors) {
#     if (length(factors) == 0) return(0)
...
regEPS_NMKTd <- plm(EPS_NMKT_Difference ~ SpatialLag.EPS_NMKT_Difference.Lag + yrsoffc + eiec + gov_left + gov_right + GovEffectiveness + GDP_PC + GHG_Int + Gini, data=FlowM[which(FlowM$Year %in% keyperiod),], index=c("ISO","Year"), model = "within", effect = "twoways")
res <- summary(regEPS_NMKTd)
res
res_robust<-coeftest(regEPS_NMKTd, vcov.=vcovHC(regEPS_NMKTd, method="white2", type="HC1"))
res_robust
# 
write.csv(res_robust, file="D:/Projects/2_Working Papers/Margherita/Revision NComm 2025/01-15/EPS_NMKT_Difference_CPDEPS.csv")
# 
# reg_pformula <- function(factors) {
#     if (length(factors) == 0) return(0)
...
#Panel
regTECHSUP <-plm(TECHSUP ~ TECHSUP.Lag + SpatialLag.TECHSUP.Lag + yrsoffc + eiec + gov_left + gov_right + GovEffectiveness + GDP_PC + GHG_Int + Gini, data=FlowM[which(FlowM$Year %in% keyperiod),], index=c("ISO","Year"), model = "within", effect = "twoways")
res <- summary(regTECHSUP)
res
res_robust<-coeftest(regTECHSUP, vcov.=vcovHC(regTECHSUP, method="white2", type="HC1"))
res_robust
# 
write.csv(res_robust, file="D:/Projects/2_Working Papers/Margherita/Revision NComm 2025/01-15/EPS_TECHSUP_CPDEPS_lag.csv")
# 
# reg_pformula <- function(factors) {
#     if (length(factors) == 0) return(0)
...
regTECHSUPd <- plm(TECHSUP_Difference ~ SpatialLag.TECHSUP_Difference.Lag + yrsoffc + eiec + gov_left + gov_right + GovEffectiveness + GDP_PC + GHG_Int + Gini, data=FlowM[which(FlowM$Year %in% keyperiod),], index=c("ISO","Year"), model = "within", effect = "twoways")
res <- summary(regTECHSUPd)
res
res_robust<-coeftest(regTECHSUPd, vcov.=vcovHC(regTECHSUPd, method="white2", type="HC1"))
res_robust
# 
write.csv(res_robust, file="D:/Projects/2_Working Papers/Margherita/Revision NComm 2025/01-15/TECHSUP_Difference_CPDEPS.csv")
# 
# reg_pformula <- function(factors) {
#     if (length(factors) == 0) return(0)
